...
function toneFor(status: string): Tone {
  ...
  if (["pending", "unpaid", "requested", "quote", "searching", "dispatching"].includes(s)) return AMBER;
  ...
  if (["cancelled", "canceled", "no_show", "declined", "failed", "refunded"].includes(s)) return RED;
  return GRAY;
}
