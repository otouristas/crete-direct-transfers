...
export type AirportData = {
  ...
  country: string;
  /** Country route slug for market-hub airports. */
  countrySlug?: string;
  island?: string;
  region?: string;
  heroImage: string;
...
export const AIRPORTS: AirportData[] = [
  {
    ...
    intro:
      "Crete Heraklion Airport sits just 4 km from the island’s largest city. Pre-booking a private TransferAround transfer guarantees a licensed local driver waiting at arrivals with your name — no taxi queues, no surge pricing.",
    knowBefore: [
      {
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Chania Airport is the west-Crete gateway, about 14 km from the Venetian harbour. TransferAround drivers know Old Town drop-off limits and resort access roads from Platanias to Kissamos.",
    knowBefore: [
      {
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Athens Airport handles 30M+ passengers a year across two terminals. TransferAround partners meet you at arrivals with a name sign, monitor your flight, and include motorway tolls in the fixed quote.",
    knowBefore: [
      {
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Thessaloniki Airport is Greece’s second busiest hub. TransferAround partners cover both terminals with meet & greet and fixed quotes into the city and Halkidiki resorts.",
    knowBefore: [
      {
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Mykonos Airport (JMK) is minutes from Ornos and Platys Yialos. Summer queues at the taxi rank are notorious — pre-book a TransferAround private transfer for a fixed quote and meet & greet.",
    knowBefore: [
      {
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Santorini Airport (JTR) feeds Fira, Oia, Kamari and Perissa. TransferAround quotes cover cliff-top hotels with clear drop-off notes for pedestrian zones.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Corfu Airport sits ~2 km from Corfu Town. TransferAround partners cover Paleokastritsa, Dassia, Kavos and the north coast on fixed quotes.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Rhodes Airport (RHO) is the Dodecanese hub. TransferAround covers the medieval town, Faliraki, Lindos and west-coast resorts with fixed quotes.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals hall with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Zakynthos Airport (ZTH) sits near Laganas. TransferAround quotes cover town, Tsilivi, and resort strips with flight monitoring for late charters.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Kefalonia Airport (EFL) is close to Argostoli. TransferAround covers Lixouri ferry connections and south-coast resorts on fixed quotes.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals hall with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Kos Airport (KGS) is inland. TransferAround quotes cover Kos Town, Kardamena and Mastichari with meet & greet.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Aktion (PVK) serves Lefkada from the mainland. TransferAround drivers cross to Lefkada Town, Nikiana and Vassiliki on fixed quotes.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals hall with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Paros Airport (PAS) is minutes from Parikia. TransferAround covers Naoussa and beach resorts with fixed quotes — better than hunting taxis after island hoppers.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Naxos Airport (JNX) sits by the west coast. TransferAround quotes cover Chora and Agia Anna with meet & greet for families and villa guests.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Milos Airport (MLO) feeds Adamas port and Plaka. TransferAround fixed quotes beat waiting for scarce taxis after afternoon arrivals.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Mytilene Airport (MJT) is close to the capital of Lesbos. TransferAround quotes cover Mytilene and north-coast Molyvos.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals hall with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Sitia Airport (JSH) serves east Crete. TransferAround offers instant Crete pricing where catalogued and quotes for villa drop-offs toward Vai and the southeast coast.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
        body: "Your TransferAround driver waits at arrivals exit with name sign. Free 60-minute wait covers delays and baggage.",
  ...
  },
  {
    ...
    updatedAt: "2026-07-24",
    intro:
      "Kalamata International Airport (KLX) is the Peloponnese charter gateway. TransferAround partners include A7 tolls in your fixed quote and meet you at the baggage-hall exit.",
    knowBefore: [
      {
        title: "Meet & greet at arrivals",
