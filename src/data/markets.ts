...
export const MARKETS: Market[] = [
  {
    ...
    featuredCitySlugs: ["heraklion", "chania", "athens", "thessaloniki"],
  ...
  },
  {
    ...
    searchIntents: [
      ...
      "Portugal city-to-city chauffeur",
      "Cruise port transfers in Portugal",
    ],
    featuredAirportSlugs: [
  ...
  },
  {
    ...
    searchIntents: [
      "Larnaca airport private transfer",
      "Paphos airport transfer",
      "Larnaca airport to Limassol",
      "Cyprus resort transfers",
      "Ayia Napa airport transfer",
      "Private chauffeur in Cyprus",
    ],
  ...
  },
  {
    ...
    searchIntents: [
      ...
      "Antalya airport to resort transfer",
      "Dalaman airport transfer",
      "Bodrum airport private transfer",
