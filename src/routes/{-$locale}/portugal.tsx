...
export const Route = createFileRoute("/{-$locale}/portugal")({
  loader: ({ params }) => {
    const locale = (params.locale ?? "en") as Locale;
    const market = getLocalizedMarket(locale, "portugal");
  ...
  head: ({ loaderData, params }) => {
    ...
    return buildHead({
      ...
      jsonLd: {
        ...
        "@type": "Service",
        "@id": `${buildCanonicalUrl(locale, "/portugal")}#service`,
  ...
  component: function PortugalPage() {
