    ...
    <>
      <section className="border-b border-border bg-muted">
        <div className="mx-auto max-w-4xl px-6 py-16 md:py-20">
          ...
          <h1 className="mt-3 text-4xl md:text-6xl font-display text-primary">For hotels.</h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
            A guest transfer that reflects your standards. Fixed prices, named drivers, one number
            for your concierge to call.
          </p>
        </div>
      </section>
      <section className="mx-auto max-w-6xl px-6 py-16 grid gap-12 lg:grid-cols-2 items-start">
        <div>
          <h2 className="font-display text-2xl text-primary">What partner hotels get</h2>
