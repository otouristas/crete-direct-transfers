...
export const en = {
  ...
  account: {
    ...
    cancelBody: "This can't be undone. Cancellation is free up to 24 hours before pickup.",
  ...
  driver: {
    ...
    confirmNoShow: "Mark as no-show? Only after the agreed waiting time has passed.",
