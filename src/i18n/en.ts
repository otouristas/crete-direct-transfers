...
export const en = {
  ...
  account: {
    ...
    liveTrip: {
      title: "Live trip",
      liveNow: "Live",
      etaPickup: "Driver arrives in",
      etaDropoff: "Arrival at destination in",
      stageToPickup: "On the way to you",
      stageWaiting: "Waiting at pickup",
      stageOnTrip: "On your transfer",
      waitingForSignal: "Waiting for the driver to start sharing their position. It goes live shortly before pickup.",
      staleSignal: "Signal paused",
      demoNotice: "Simulated demo movement",
      reconnecting: "Reconnecting…",
      callDriver: "Call driver",
      whatsappDriver: "WhatsApp driver",
      minutes: (n: number) => `${n} min`,
      away: (km: number) => `${km.toFixed(1)} km away`,
      updatedAgo: (n: number) => (n <= 0 ? "Updated just now" : `Updated ${n} min ago`),
    },
    ...
    timelineBooked: "Booking confirmed",
    timelineDriverAssigned: "Driver assigned",
    timelineEnRoute: "Driver en route",
    timelineCompleted: "Transfer completed",
    timelineCancelled: "Booking cancelled",
    timelinePending: "Waiting for a driver",
    downloadReceipt: "Download receipt",
    receiptTitle: "Receipt",
    bookedThisWeek: "{count} transfers booked this week",
    verifiedReviews: "Verified traveller reviews",
    licensedDrivers: "Licensed, insured drivers",
    securePayment: "Secure payment",
    resumeQuoteTitle: "Continue where you left off",
    resumeQuoteCta: "Resume my quote",
    dismiss: "Dismiss",
  ...
  driver: {
    ...
    liveShare: {
      ...
      stop: "Stop sharing",
      unsupported: "Location sharing is not available on this device.",
      denied: "Location permission denied.",
      failed: "Could not send your position.",
    },
