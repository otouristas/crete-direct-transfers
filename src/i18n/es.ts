...
export const es: Dict = {
  ...
  home: {
    ...
    mapEyebrow: "Ruta en vivo",
    mapTitle: "Mira cómo se dibuja tu ruta",
    mapHint: "Elige recogida y destino para trazar la línea por la isla.",
    mapDistance: (km: number, min: number) =>
      `${km} km · unos ${min} min en coche`,
  ...
  account: {
    ...
    liveTrip: {
      title: "Viaje en directo",
      liveNow: "En directo",
      etaPickup: "El conductor llega en",
      etaDropoff: "Llegada al destino en",
      stageToPickup: "En camino hacia ti",
      stageWaiting: "Esperando en el punto de recogida",
      stageOnTrip: "Traslado en curso",
      waitingForSignal: "Esperando a que el conductor comparta su posición. Se activa poco antes de la recogida.",
      staleSignal: "Señal en pausa",
      demoNotice: "Movimiento de demostración",
      reconnecting: "Reconectando…",
      callDriver: "Llamar al conductor",
      whatsappDriver: "WhatsApp al conductor",
      minutes: (n: number) => `${n} min`,
      away: (km: number) => `a ${km.toFixed(1)} km`,
      updatedAgo: (n: number) => (n <= 0 ? "Actualizado ahora mismo" : `Actualizado hace ${n} min`),
    },
    ...
    timelineTitle: "Cronología del viaje",
    timelineBooked: "Reserva confirmada",
    timelineDriverAssigned: "Conductor asignado",
    timelineEnRoute: "Conductor en camino",
    timelineCompleted: "Traslado completado",
    timelineCancelled: "Reserva cancelada",
    timelinePending: "Esperando un conductor",
    downloadReceipt: "Descargar recibo",
    receiptTitle: "Recibo",
    bookedThisWeek: "{count} traslados reservados esta semana",
    verifiedReviews: "Opiniones verificadas de viajeros",
    licensedDrivers: "Conductores con licencia y asegurados",
    securePayment: "Pago seguro",
    resumeQuoteTitle: "Continúa donde lo dejaste",
    resumeQuoteCta: "Retomar mi presupuesto",
    dismiss: "Descartar",
  ...
  driver: {
    ...
    statsToday: "Viajes de hoy",
    statsUpcoming: "Próximos",
    statsPending: "Ganancias pendientes",
    ...
    liveShare: {
      start: "Compartir ubicación en directo",
      stop: "Dejar de compartir",
      unsupported: "Compartir ubicación no está disponible en este dispositivo.",
      denied: "Permiso de ubicación denegado.",
      failed: "No se pudo enviar tu posición.",
    },
  ...
  driverAccount: {
    balanceTitle: "Saldo de la cuenta",
    ...
    ledgerTitle: "Movimientos de la cuenta",
    ...
    colAmount: "Amount",
    colStatus: "Status",
    typeEarning: "Ingresos",
    typeCommission: "Comisión",
    typePenalty: "Penalización",
    typeIncentive: "Incentivo",
    typePayout: "Pago",
    typeAdjustment: "Ajuste",
    cancelJob: "Cancelar servicio",
    cancelTitle: "¿Cancelar este traslado?",
    ...
    urgentBadge: "Última hora",
    incentiveBadge: "Incentivo",
    opsTitle: "Cuentas de conductores",
  ...
  payouts: {
    ...
    subtitle: "Tu parte es el 85 % de cada trayecto completado. Los pagos se realizan tras el periodo de retención.",
    ...
    setupContinue: "Finalizar configuración",
    statusNotStarted: "Sin empezar",
    statusInReview: "En revisión",
    statusReady: "Listo para cobrar",
    stripeDashboard: "Abrir panel de Stripe",
    unavailable: "Los pagos aún no están activados en este sitio.",
    scheduleTitle: "Frecuencia de pago",
    weekly: "Semanal (predeterminada)",
    monthly: "Mensual",
    instant: "Instantánea",
    instantLocked: "Los pagos instantáneos aún no están disponibles en tu cuenta.",
    scheduleSaved: "Frecuencia de pago actualizada",
    holdingNote: "Las ganancias quedan disponibles cuando el trayecto se completa y pasa el periodo de retención. Cancelaciones, ausencias y disputas bloquean el pago.",
    bookingsTitle: "Ganancias por reserva",
    bookingsEmpty: "Completa tu primer servicio para ver ganancias aquí.",
    colDate: "Fecha",
    colRoute: "Trayecto",
    colFare: "Tarifa",
    ...
    historyEmpty: "Todavía no hay pagos.",
    colAmount: "Importe",
    colMethod: "Método",
    colSent: "Enviado",
    sPending: "Pendiente",
    ...
    sPaid: "Pagado",
    sVoided: "Bloqueado",
    sDisputed: "En disputa",
    methodStandard: "Estándar",
    methodInstant: "Instantáneo",
    opsTitle: "Pagos y ganancias",
    opsEmpty: "Aún no hay ganancias registradas.",
    opsRunPayouts: "Ejecutar pagos ahora",
    opsRunDone: "Ronda de pagos finalizada",
    opsRefund: "Reembolsar",
    opsRefundDone: "Reembolso emitido",
    opsHold: "Retener",
    opsRelease: "Liberar",
    opsVoid: "Bloquear",
    opsUpdated: "Actualizado",
    opsFailed: "La acción falló",
    opsSettings: "Ajustes de pago",
    opsCommission: "Comisión (%)",
    opsHolding: "Periodo de retención (horas)",
    opsDefaultSchedule: "Frecuencia predeterminada",
    opsMinPayout: "Pago mínimo (€)",
    opsSave: "Guardar ajustes",
    opsSaved: "Ajustes guardados",
    opsPayoutsTitle: "Lotes de pago",
    opsDriver: "Conductor",
    opsBooking: "Reserva",
  },
  contracts: {
    title: "Contratos",
    subtitle: "Lee, firma y descarga tus contratos de colaboración.",
    driverAgreement: "Contrato de colaboración con conductor",
    partnerAgreement: "Contrato de socio / agencia de viajes",
    statusPending: "Pendiente de firma",
    statusSigned: "Firmado",
    statusVoid: "Anulado",
    readPrompt: "Lee el contrato completo antes de firmar. El texto griego es el vinculante.",
    typedNameLabel: "Nombre completo (firma escrita)",
    typedNamePlaceholder: "p. ej. Georgios Papadakis",
    acceptLabel: "He leído y acepto el contrato anterior.",
    signButton: "Firmar contrato",
    signing: "Firmando…",
    signedOn: "Firmado el",
    signedBy: "Firmado por",
    downloadPdf: "Descargar PDF",
    none: "Todavía no hay contratos.",
    auditTitle: "Registro de firma",
    fingerprint: "Huella del documento",
    mustAccept: "Escribe tu nombre y marca la aceptación.",
    signError: "No se pudo firmar. Inténtalo de nuevo.",
    signSuccess: "Contrato firmado.",
    opsTitle: "Contratos",
    opsIssue: "Emitir contrato",
    opsIssueFor: "Emitir contrato para un ID de usuario",
    opsCommission: "Comisión %",
    opsNoticeDays: "Preaviso (días)",
    opsPartnershipType: "Tipo de colaboración",
    opsSpecialTerms: "Condiciones especiales (opcional)",
    opsSend: "Emitir",
    opsSent: "Contrato emitido.",
    opsFailed: "Acción fallida.",
    opsNoContracts: "No hay contratos.",
    view: "Ver",
    gate: "Debes firmar el contrato de conductor antes de que se apruebe tu cuenta.",
  },
};
