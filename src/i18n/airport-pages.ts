...
const copy: Record<"en" | "el" | "de" | "fr" | "it" | "nl" | "es", Copy> = {
  ...
  el: {
    ...
    heroDescription:
      "Ιδιωτικές μεταφορές σταθερής τιμής με αδειοδοτημένους τοπικούς οδηγούς, υποδοχή, παρακολούθηση πτήσης και 60 λεπτά δωρεάν αναμονή.",
    ...
    privateHire: "Αδειοδοτημένη ιδιωτική μεταφορά",
    arrivalCare: "Φροντίδα άφιξης",
    transparentFares: "Διαφανείς τιμές",
    flexibility: "Ευελιξία",
    trustHighlights: "Στοιχεία εμπιστοσύνης",
    knowBeforeTitle: "Τι να γνωρίζετε πριν τη μεταφορά σας στο {0} ({1})",
    knowBeforeBody:
      "Διόδια, χρεώσεις, σημεία παραλαβής και τοπικοί κανόνες που επηρεάζουν τη μεταφορά σας στο {0}.",
    ...
    comparisonBody: "Πραγματικός χρόνος, κόστος και επιλογές μετακίνησης στο αεροδρόμιο.",
    mode: "Μέσο",
    cost: "Κόστος",
    pros: "Πλεονεκτήματα",
    cons: "Μειονεκτήματα",
    ...
    vehiclesBody:
      "Επιλέξτε το κατάλληλο όχημα για την ομάδα σας. Όλες οι τιμές είναι σταθερές και περιλαμβάνουν υποδοχή.",
