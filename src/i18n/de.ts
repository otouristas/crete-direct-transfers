...
export const de: Dict = {
  ...
  account: {
    ...
    liveTrip: {
      title: "Live-Fahrt",
      liveNow: "Live",
      etaPickup: "Fahrer da in",
      etaDropoff: "Ankunft am Ziel in",
      stageToPickup: "Auf dem Weg zu Ihnen",
      stageWaiting: "Wartet am Abholort",
      stageOnTrip: "Transfer läuft",
      waitingForSignal: "Wir warten darauf, dass der Fahrer seine Position teilt. Das startet kurz vor der Abholung.",
      staleSignal: "Signal pausiert",
      demoNotice: "Simulierte Demo-Bewegung",
      reconnecting: "Verbindung wird wiederhergestellt…",
      callDriver: "Fahrer anrufen",
      whatsappDriver: "Fahrer per WhatsApp",
      minutes: (n: number) => `${n} min`,
      away: (km: number) => `${km.toFixed(1)} km entfernt`,
      updatedAgo: (n: number) => (n <= 0 ? "Gerade aktualisiert" : `Aktualisiert vor ${n} Min.`),
    },
    ...
    timelineTitle: "Reiseverlauf",
    timelineBooked: "Buchung bestätigt",
    timelineDriverAssigned: "Fahrer zugewiesen",
    timelineEnRoute: "Fahrer unterwegs",
    timelineCompleted: "Transfer abgeschlossen",
    timelineCancelled: "Buchung storniert",
    timelinePending: "Warten auf einen Fahrer",
    downloadReceipt: "Beleg herunterladen",
    receiptTitle: "Beleg",
    bookedThisWeek: "{count} Transfers diese Woche gebucht",
    verifiedReviews: "Verifizierte Reisebewertungen",
    licensedDrivers: "Lizenzierte, versicherte Fahrer",
    securePayment: "Sichere Zahlung",
    resumeQuoteTitle: "Dort weitermachen, wo Sie aufgehört haben",
    resumeQuoteCta: "Angebot fortsetzen",
    dismiss: "Ausblenden",
  ...
  driver: {
    ...
    liveShare: {
      start: "Live-Standort teilen",
      stop: "Teilen beenden",
      unsupported: "Standortfreigabe ist auf diesem Gerät nicht verfügbar.",
      denied: "Standortzugriff verweigert.",
      failed: "Position konnte nicht gesendet werden.",
    },
