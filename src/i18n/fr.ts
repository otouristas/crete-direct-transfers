...
export const fr: Dict = {
  ...
  account: {
    ...
    liveTrip: {
      title: "Trajet en direct",
      liveNow: "En direct",
      etaPickup: "Le chauffeur arrive dans",
      etaDropoff: "Arrivée à destination dans",
      stageToPickup: "En route vers vous",
      stageWaiting: "Attend au point de prise en charge",
      stageOnTrip: "Transfert en cours",
      waitingForSignal: "En attente du partage de position du chauffeur. Il s'active peu avant la prise en charge.",
      staleSignal: "Signal en pause",
      demoNotice: "Déplacement de démonstration",
      reconnecting: "Reconnexion…",
      callDriver: "Appeler le chauffeur",
      whatsappDriver: "WhatsApp au chauffeur",
      minutes: (n: number) => `${n} min`,
      away: (km: number) => `à ${km.toFixed(1)} km`,
      updatedAgo: (n: number) => (n <= 0 ? "Mis à jour à l'instant" : `Mis à jour il y a ${n} min`),
    },
    ...
    timelineTitle: "Déroulé du trajet",
    timelineBooked: "Réservation confirmée",
    timelineDriverAssigned: "Chauffeur attribué",
    timelineEnRoute: "Chauffeur en route",
    timelineCompleted: "Transfert terminé",
    timelineCancelled: "Réservation annulée",
    timelinePending: "En attente d'un chauffeur",
    downloadReceipt: "Télécharger le reçu",
    receiptTitle: "Reçu",
    bookedThisWeek: "{count} transferts réservés cette semaine",
    verifiedReviews: "Avis vérifiés de voyageurs",
    licensedDrivers: "Chauffeurs licenciés et assurés",
    securePayment: "Paiement sécurisé",
    resumeQuoteTitle: "Reprenez là où vous en étiez",
    resumeQuoteCta: "Reprendre mon devis",
    dismiss: "Ignorer",
  ...
  driver: {
    ...
    liveShare: {
      start: "Partager ma position",
      stop: "Arrêter le partage",
      unsupported: "Le partage de position n'est pas disponible sur cet appareil.",
      denied: "Autorisation de localisation refusée.",
      failed: "Impossible d'envoyer votre position.",
    },
