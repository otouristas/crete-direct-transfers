...
export const nl: Dict = {
  ...
  account: {
    ...
    liveTrip: {
      title: "Live rit",
      liveNow: "Live",
      etaPickup: "Chauffeur arriveert over",
      etaDropoff: "Aankomst op bestemming over",
      stageToPickup: "Onderweg naar u",
      stageWaiting: "Wacht op de ophaalplek",
      stageOnTrip: "Transfer onderweg",
      waitingForSignal: "We wachten tot de chauffeur zijn positie deelt. Dit start kort voor het ophalen.",
      staleSignal: "Signaal gepauzeerd",
      demoNotice: "Gesimuleerde demobeweging",
      reconnecting: "Opnieuw verbinden…",
      callDriver: "Bel chauffeur",
      whatsappDriver: "WhatsApp chauffeur",
      minutes: (n: number) => `${n} min`,
      away: (km: number) => `${km.toFixed(1)} km verderop`,
      updatedAgo: (n: number) => (n <= 0 ? "Zojuist bijgewerkt" : `${n} min geleden bijgewerkt`),
    },
  ...
  driver: {
    ...
    liveShare: {
      start: "Live locatie delen",
      stop: "Delen stoppen",
      unsupported: "Locatie delen is niet beschikbaar op dit apparaat.",
      denied: "Locatietoestemming geweigerd.",
      failed: "Kon je positie niet versturen.",
    },
